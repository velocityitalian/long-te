"""
YouTube Upload Script for Velocity Telugu
"""
...
def ensure_playlist(youtube, title="Learn Telugu Phrases for Beginners | Velocity Telugu", description="All telugu phrases videos in one playlist. 🇮🇳 Learn Telugu with Velocity Telugu!"):
...
def upload_to_youtube(video_info):
    ...
    video_metadata = {
        "snippet": {"title": title, "description": description[:4800],
                     "tags": ["Learn Telugu", "Telugu Phrases", "Telugu Language", "Velocity Telugu", "Telugu for Beginners"],
                     "categoryId": "27"},
...
def main():
    print("VELOCITY TELUGU - YOUTUBE UPLOADER")
