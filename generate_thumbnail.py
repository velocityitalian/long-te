...
SCENIC_STYLES = [
    "stunning Indian woman in traditional saree, Tirupati temple, sunrise",
    "elegant Telugu woman in silk saree, Charminar, Hyderabad",
    "beautiful Indian woman in traditional dress, Araku Valley, green hills",
    "Indian woman at Godavari river, Rajahmundry, golden hour",
    "gorgeous Telugu woman in modern wear, Visakhapatnam beach sunset",
    "beautiful Indian woman, Warangal, thousand pillar temple, warm light",
    "Telugu woman in traditional attire, Kakinada, palm trees",
    "elegant South Indian woman, Belum Caves, zen atmosphere",
]


def generate_scenic_image(category_english: str, category_telugu: str, output_path: str):
    # Try pre-made thumbnail first
    premade = get_thumbnail("Telugu", category_english)
    if premade:
        return premade
        ...
        for attempt in range(3):
            ...
            prompt = (
                f"Professional YouTube thumbnail for Telugu language learning video. "
                f"{style}. "
                ...
                f"At top: '120 TELUGU PHRASES'. In center: '{category_english}'. "
                f"At bottom: 'VELOCITY TELUGU'. Also: '10 MINUTE LESSON' badge."
            )
            try:
    ...
    lang_fonts = [str(Path(__file__).parent / "fonts" / "NotoSansTelugu-Bold.ttf"),
    ...
    draw.text((960, 180), "120 TELUGU PHRASES", fill=(255, 210, 0), font=f_big, anchor="mm")
